...
namespace MyCore.Migrations
{
    ...
    [Migration("20181107135155_editStoreMove")]
    partial class editStoreMove
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyCore.Models.Store.StoreMoveBill", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("StoreMoveBill");
                });

            modelBuilder.Entity("MyCore.Models.Store.StoreMoveBill_MX", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("MyCore.Models.Store.StoreMoveBill_MX", b =>
                {
                    b.HasOne("MyCore.Models.Store.StoreMoveBill", "StoreMoveBill")
                        .WithMany("StoreMoveBill_MX")
                        .HasForeignKey("Bill_id")
                        .OnDelete(DeleteBehavior.Cascade);
                });
