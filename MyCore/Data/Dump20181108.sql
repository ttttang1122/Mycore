...
INSERT INTO `goodsstore` VALUES (11,NULL,'包','10g','0003','创口贴',3,'123','10',10.00,10.00,'拉稀客','123','成品仓库',1,'2018-02-02 00:00:00','2020-02-02 00:00:00'),(12,NULL,'234','234','0001','棉签',1,'123','234',14.00,20.00,'234','123','成品仓库',1,'2018-02-02 00:00:00','2020-02-02 00:00:00'),(13,NULL,'包','10g','0003','创口贴',3,'123','10',0.00,10.00,'拉稀客','123','的风格的',2,'2018-02-02 00:00:00','2020-02-02 00:00:00'),(14,NULL,'234','234','0001','棉签',1,'123','234',4.00,20.00,'234','123','的风格的',2,'2018-02-02 00:00:00','2020-02-02 00:00:00'),(15,NULL,'234','234','0001','棉签',1,'456','234',0.00,20.00,'234','456','成品仓库',1,'2018-02-02 00:00:00','2020-02-02 00:00:00'),(16,NULL,'包','10g','0003','创口贴',3,NULL,'10',0.00,10.00,'拉稀客',NULL,'成品仓库',1,NULL,NULL),(17,NULL,'234','234','0001','棉签',1,NULL,'234',0.00,20.00,'234',NULL,'成品仓库',1,NULL,NULL),(18,NULL,'包','10g','0003','创口贴',3,'123','10',50.00,20.00,'拉稀客','123','成品仓库',1,'2018-05-02 00:00:00','2020-05-02 00:00:00'),(19,NULL,'234','234','0001','棉签',1,'123','234',33.00,20.00,'234','123','成品仓库',1,'2018-05-02 00:00:00','2020-05-02 00:00:00'),(20,NULL,'包','10g','0003','创口贴',3,'456','10',30.00,5.00,'拉稀客','456','成品仓库',1,'2018-02-05 00:00:00','2019-02-02 00:00:00'),(21,NULL,'234','234','0001','棉签',1,'456','234',39.00,8.00,'234','456','成品仓库',1,'2018-02-05 00:00:00','2019-02-02 00:00:00'),(22,NULL,'包','10g','0003','创口贴',3,'456','10',50.00,10.00,'拉稀客','456','成品仓库',1,'2018-02-02 00:00:00','2020-02-02 00:00:00'),(23,NULL,'234','234','0001','棉签',1,'456','234',90.00,11.00,'234','456','成品仓库',1,'2018-02-02 00:00:00','2020-02-02 00:00:00'),(24,NULL,'包','10g','0003','创口贴',3,NULL,'10',12.00,1.34,'拉稀客',NULL,'成品仓库',1,NULL,NULL),(25,NULL,'234','234','0001','棉签',1,NULL,'234',5.00,2.55,'234',NULL,'成品仓库',1,NULL,NULL),(26,NULL,'包','10g','0003','创口贴',3,NULL,'10',10.00,12.55,'拉稀客','123','成品仓库',1,NULL,NULL),(27,NULL,'234','234','0001','棉签',1,NULL,'234',9.00,13.53,'234','12-','成品仓库',1,NULL,NULL),(28,NULL,'包','10g','0003','创口贴',3,NULL,'10',11.00,30.36,'拉稀客',NULL,'的风格的',2,NULL,NULL),(29,NULL,'234','234','0001','棉签',1,NULL,'234',10.00,100.00,'234',NULL,'的风格的',2,NULL,NULL),(30,NULL,'234','234','0001','棉签',1,'123','234',4.00,20.00,'234','123','的风格的',2,'2018-05-02 00:00:00','2020-05-02 00:00:00');
...
--
-- Table structure for table `storemovebill`
--

DROP TABLE IF EXISTS `storemovebill`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `storemovebill` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `BZ` varchar(200) DEFAULT NULL,
  `BillDate` datetime DEFAULT NULL,
  `BillID` varchar(45) DEFAULT NULL,
  `CreateDate` datetime DEFAULT NULL,
  `CreateName` varchar(45) DEFAULT NULL,
  `InStoreName` varchar(45) DEFAULT NULL,
  `InStroeInfo_id` int(11) NOT NULL,
  `OutStoreName` varchar(45) DEFAULT NULL,
  `OutStroeInfo_id` int(11) NOT NULL,
  `SHDate` datetime DEFAULT NULL,
  `SHName` varchar(45) DEFAULT NULL,
  `Status` int(11) DEFAULT NULL,
  `YSName` varchar(45) DEFAULT NULL,
...
--
-- Dumping data for table `storemovebill`
--

LOCK TABLES `storemovebill` WRITE;
/*!40000 ALTER TABLE `storemovebill` DISABLE KEYS */;
INSERT INTO `storemovebill` VALUES (1,'3234234','2018-11-08 00:00:00','MV.20181108195506','2018-11-08 19:55:08','US-0001','的风格的',2,'成品仓库',1,'2018-11-08 19:55:07','US-0001',1,'战三',2),(2,NULL,'2018-11-08 00:00:00','MV.20181108195557','2018-11-08 19:55:57','US-0001','的风格的',2,'成品仓库',1,'2018-11-08 19:55:57','US-0001',1,'战三',2),(3,NULL,'2018-11-08 00:00:00','MV.20181108195656','2018-11-08 19:56:57','US-0001','的风格的',2,'成品仓库',1,'2018-11-08 20:32:27','US-0001',1,'战三',2);
/*!40000 ALTER TABLE `storemovebill` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `storemovebill_mx`
--

DROP TABLE IF EXISTS `storemovebill_mx`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `storemovebill_mx` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `BZ` varchar(200) DEFAULT NULL,
  `Bill_id` int(11) NOT NULL,
  `DW` varchar(45) DEFAULT NULL,
  ...
  `Good_id` int(11) NOT NULL,
  `InStoreName` varchar(45) DEFAULT NULL,
  `InStroeInfo_id` int(11) DEFAULT NULL,
  `MJPH` varchar(100) DEFAULT NULL,
  `ModelType` varchar(45) DEFAULT NULL,
  `Num` decimal(18,2) NOT NULL,
  `OutStoreName` varchar(45) DEFAULT NULL,
  `OutStroeInfo_id` int(11) DEFAULT NULL,
  `SCCJ` varchar(145) DEFAULT NULL,
  `SCPH` varchar(100) DEFAULT NULL,
  `StoreRow` int(11) DEFAULT NULL,
  `scDate` datetime DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `IX_StoreMoveBill_MX_Bill_id` (`Bill_id`),
  CONSTRAINT `FK_StoreMoveBill_MX_StoreMoveBill_Bill_id` FOREIGN KEY (`Bill_id`) REFERENCES `storemovebill` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `storemovebill_mx`
--

LOCK TABLES `storemovebill_mx` WRITE;
/*!40000 ALTER TABLE `storemovebill_mx` DISABLE KEYS */;
INSERT INTO `storemovebill_mx` VALUES (1,NULL,1,'234','234','0001','棉签',1,'的风格的',2,'123','234',1.00,'成品仓库',1,'234','123',12,'2018-02-02 00:00:00','2020-02-02 00:00:00',20.00),(2,NULL,1,'234','234','0001','棉签',1,'的风格的',2,'123','234',1.00,'成品仓库',1,'234','123',19,'2018-05-02 00:00:00','2020-05-02 00:00:00',20.00),(3,NULL,2,'234','234','0001','棉签',1,'的风格的',2,'123','234',1.00,'成品仓库',1,'234','123',12,'2018-02-02 00:00:00','2020-02-02 00:00:00',20.00),(4,NULL,2,'234','234','0001','棉签',1,'的风格的',2,'123','234',1.00,'成品仓库',1,'234','123',19,'2018-05-02 00:00:00','2020-05-02 00:00:00',20.00),(7,NULL,3,'234','234','0001','棉签',1,'的风格的',2,'123','234',2.00,'成品仓库',1,'234','123',12,'2018-02-02 00:00:00','2020-02-02 00:00:00',20.00),(8,NULL,3,'234','234','0001','棉签',1,'的风格的',2,'123','234',2.00,'成品仓库',1,'234','123',19,'2018-05-02 00:00:00','2020-05-02 00:00:00',20.00);
/*!40000 ALTER TABLE `storemovebill_mx` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-11-08 20:35:52
